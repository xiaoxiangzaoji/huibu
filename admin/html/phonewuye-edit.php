...
<article class="page-container">
   ...
   <?php
                if(!$_GET["id"]){
                 ...
                 $sql="select * from phone_wuye where id='{$ID}'";
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo $v['deve_company'] ?>" placeholder="" id="adminName" name="adminName">
		</div>
	</div>
	<div class="row cl">
...
$(function(){
	...
	function refer(){  
	    if(t==0){ 
	        window.location.href="phone-wuye.php";  //#设定跳转的链接地址 
	    }else{
	   		t--; // 计数器递减 
		}
	} 
