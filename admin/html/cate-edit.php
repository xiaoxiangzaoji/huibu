...
<div class="page-container">
  ...
  <form class="form form-horizontal" id="form-admin-add">
    <?php
                 ...
                 $id = $_GET['id'];
                 $sql="select * from `news_categroy` where id = '$id'";
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" value="<?php echo $v['categroyname'] ?>" placeholder="" id="categoryname" name="adminName">
        </div>
    </div>
...
$('.btn').bind('click',function(){
    ...
    $.ajax({
        type:"post",
        url:"/cms/admin/php/cate_edit.php",
