...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" ENCTYPE="multipart/form-data" method= "post" action= "../php/shop_product-edit.php">
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>当前商铺图片：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<img src="<?php echo $v['photo'] ?>" alt="" width="200px" height="100px">
		</div>
	</div>
	<div class="row cl">
	...
	<div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>选择店铺图片：</label>
            <div class="formControls col-xs-8 col-sm-9">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo $v['live'] ?>" placeholder="" id="details" name="details">
		</div>
	</div>
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="text" class="input-text" value="<?php echo $v['dress'] ?>" placeholder="" id="load" name="load">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">交通路线：</label>
		<div class="formControls col-xs-8 col-sm-9">
