...
<title>修改手机端banner</title>
</head>
<body>

<article class="page-container">

    <form class="form form-horizontal" id="form-article-add" ENCTYPE="multipart/form-data" method= "post" action= "../php/phone-edit.php">
        ...
        <?php
                if(!$_GET["id"]){
                 ...
                 $sql="select * from `phone_banner` where id='{$ID}'";
      ...
      ?>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
               <img src="<?php echo $v['picture']?>" alt="当前暂时未有图片" width="200px">
            </div>
        </div>
